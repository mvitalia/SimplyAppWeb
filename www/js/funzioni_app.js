...
$(document).ready(function () {
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                if (localStorage.getItem("argomento") == "")
                {
                    ...
                    caricaSulSitoArgomento(posizione, titolo, data, sottotitolo, descrizione_breve, descrizione);
                }
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                if (localStorage.getItem("categoria_prodotto") == "") {
                    ...
                    caricaSulSitoProdotto(posizione, nome, descrizione_breve, descrizione);
                }
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                if (localStorage.getItem("categoria_realizzazione") == "") {
                    ...
                    caricaSulSitoRealizzazione(posizione, nome, descrizione_breve, descrizione);
                }
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                if (localStorage.getItem("categoria_servizi_cat") == "") {
                    ...
                    caricaSulSitoServiziCat(posizione, nome, descrizione_breve, descrizione);
                }
    ...
    $('#modificaArgomento').validate({
        ...
        submitHandler: function (form) {
            ...
            var descrizione_breve_modifica = $("#descrizione_breve_modifica").val();
            aggiornaArgomento(titolo_modifica, data_modifica, sottotitolo_modifica, descrizione_breve_modifica, descrizione_modifica);
    ...
    $('#pubblicaProdottoModifica').validate({
        ...
        submitHandler: function (form) {
            var posizione_modifica = $("#posizione_prodotto_modifica").val();
            var nome_modifica = $("#nome_prodotto_modifica").val();
            tinyMCE.triggerSave();
            var descrizione_modifica = $("#descrizione_prodotto_modifica").val();
            var descrizione_breve_modifica = $("#descrizione_breve_prodotto_modifica").val();
           
            aggiornaProdotto(posizione_modifica, nome_modifica, descrizione_breve_modifica, descrizione_modifica);
            // Quando torno vai alla funzione aggiorna argomento e modifica con descrizione breve e poi webservice collegato
            return false;
        }
    });
    ...
    $('#pubblicaRealizzazioneModifica').validate({
        ...
        submitHandler: function (form) {
            var posizione_modifica = $("#posizione_realizzazione_modifica").val();
            var nome_modifica = $("#nome_realizzazione_modifica").val();
            tinyMCE.triggerSave();
            var descrizione_modifica = $("#descrizione_realizzazione_modifica").val();
            var descrizione_breve_modifica = $("#descrizione_breve_realizzazione_modifica").val();
          
            aggiornaRealizzazione(posizione_modifica, nome_modifica, descrizione_breve_modifica, descrizione_modifica);
            // Quando torno vai alla funzione aggiorna argomento e modifica con descrizione breve e poi webservice collegato
            return false;
        }
    });
    ...
    $('#pubblicaServizio').validate({
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                caricaSulSitoServizio(posizione, titolo, descrizione_breve, descrizione);
            } else {
                var pubblica_sito_check = "<div class='modal-content'><h4>Condivisione Fallita </h4><p>Clicca su checkbox sito per pubblicare!! </p></div>";
                pubblica_sito_check += "<div class='modal-footer'> <a href='#' class='modal-action modal-close waves-effect waves-green btn-flat'>Chiudi</a></div>";
                $("#scegli_pubblica_sito").html("");
    ...
    $('#pubblicaServizioModifica').validate({
        ...
        submitHandler: function (form) {
            var posizione_modifica = $("#posizione_servizio_modifica").val();
            var titolo_modifica = $("#titolo_servizio_modifica").val();
            tinyMCE.triggerSave();
            var descrizione_modifica = $("#descrizione_servizio_modifica").val();
            var descrizione_breve_modifica = $("#descrizione_breve_servizio_modifica").val();

            aggiornaServizio(posizione_modifica, titolo_modifica, descrizione_breve_modifica, descrizione_modifica);
            // Quando torno vai alla funzione aggiorna argomento e modifica con descrizione breve e poi webservice collegato
            return false;
        }
    });
    ...
    $('#pubblicaServizioCatModifica').validate({
        ...
        submitHandler: function (form) {
            var posizione_modifica = $("#posizione_servizio_cat_modifica").val();
            var nome_modifica = $("#nome_servizio_cat_modifica").val();
            tinyMCE.triggerSave();
            var descrizione_modifica = $("#descrizione_servizio_cat_modifica").val();
            var descrizione_breve_modifica = $("#descrizione_breve_servizio_cat_modifica").val();

            aggiornaServizioCat(posizione_modifica, nome_modifica, descrizione_breve_modifica, descrizione_modifica);
            // Quando torno vai alla funzione aggiorna argomento e modifica con descrizione breve e poi webservice collegato
            return false;
        }
    });
    ...
    $('#pubblicaCertificazione').validate({
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                caricaSulSitoCertificazione(posizione, titolo, descrizione_breve, descrizione);
            } else {
                var pubblica_sito_check = "<div class='modal-content'><h4>Condivisione Fallita </h4><p>Clicca su checkbox sito per pubblicare!! </p></div>";
                pubblica_sito_check += "<div class='modal-footer'> <a href='#' class='modal-action modal-close waves-effect waves-green btn-flat'>Chiudi</a></div>";
                $("#scegli_pubblica_sito").html("");
    ...
    $('#pubblicaCertificazioneModifica').validate({
        ...
        submitHandler: function (form) {
            var posizione_modifica = $("#posizione_certificazione_modifica").val();
            var titolo_modifica = $("#titolo_certificazione_modifica").val();
            tinyMCE.triggerSave();
            var descrizione_modifica = $("#descrizione_certificazione_modifica").val();
            var descrizione_breve_modifica = $("#descrizione_breve_certificazione_modifica").val();

            aggiornaCertificazione(posizione_modifica, titolo_modifica, descrizione_breve_modifica, descrizione_modifica);
            // Quando torno vai alla funzione aggiorna argomento e modifica con descrizione breve e poi webservice collegato
            return false;
        }
    });
    ...
    $('#pubblicaCategoria').validate({
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                caricaSulSitoCategoria(posizione, nome, descrizione_breve);
            } else {
                var pubblica_sito_check = "<div class='modal-content'><h4>Condivisione Fallita </h4><p>Clicca su checkbox sito per pubblicare!! </p></div>";
                pubblica_sito_check += "<div class='modal-footer'> <a href='#' class='modal-action modal-close waves-effect waves-green btn-flat'>Chiudi</a></div>";
                $("#scegli_pubblica_sito").html("");
    ...
    $('#pubblicaAppartamento').validate({
        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                caricaSulSitoAppartamento(posizione, nome, prezzo, prezzo_scontato, prezzo_aggiuntivo_infante, n_locali, n_bagni, n_posti_letto, metri_quadri, comfort, descrizione, servizi_aggiuntivi);
            } else {
                var pubblica_sito_check = "<div class='modal-content'><h4>Condivisione Fallita </h4><p>Clicca su checkbox sito per pubblicare!! </p></div>";
                pubblica_sito_check += "<div class='modal-footer'> <a href='#' class='modal-action modal-close waves-effect waves-green btn-flat'>Chiudi</a></div>";
                $("#scegli_pubblica_sito").html("");
    ...
    $('#modificaAppartamentoUno').validate({
        ...
        submitHandler: function (form) {
                ...
                aggiornaAppartamento(posizione, nome, prezzo, prezzo_scontato, prezzo_aggiuntivo_infante, n_locali, n_bagni, n_posti_letto, metri_quadri, comfort, descrizione, servizi_aggiuntivi);
...
function caricaSulSitoArgomento(posizione, titolo, data, sottotitolo, descrizione_breve, descrizione) {
    var tipo_argomento = localStorage.getItem('argomento');
   
    $.ajax({
        type: "POST",
        data: '{posizione:"'+posizione+'", titolo:"' + titolo + '",data:"' + data + '",sottotitolo:"' + sottotitolo + '",descrizione_breve:"' + descrizione_breve + '",descrizione:"' + descrizione + '",ID_utente:"' + localStorage.getItem("ID_utente") + '", user:"' + localStorage.getItem("username") + '", argomento:"'+localStorage.getItem('argomento')+'"}',
...
function creoDB(tx)
{
    ...
    tx.executeSql("CREATE TABLE IF NOT EXISTS utenti (id INTEGER PRIMARY KEY AUTOINCREMENT,identificativo INTEGER, social INTEGER, sito INTEGER, news INTEGER, promo INTEGER, eventi INTEGER, gallery INTEGER, prodotti INTEGER, servizi INTEGER, realizzazioni INTEGER, serviziCat INTEGER, certificazioni INTEGER, appartamenti INTEGER, prenotazioni INTEGER)");
    ...
    $.getJSON("http://simplyappweb.mvclienti.com/webservices/seleziono_argomento.aspx?id_argomento=" + id_argomento + "&argomento=" + argomento + "&ID_utente=" + ID + "", function (dati) {
       // var blocco_news = "";
        ...
        $.each(dati, function (i, argomento) {
            ...
            $("#descrizione_breve_lbl").addClass("active");
...
function aggiornaArgomento(titolo_modifica, data_modifica, sottotitolo_modifica, descrizione_breve_modifica, descrizione_modifica)
{
  
    var tipo_argomento = localStorage.getItem('nome_argomento_modifica');
    $.ajax({
        type: "POST",
        data: '{titolo:"' + titolo_modifica + '",data:"' + data_modifica + '",sottotitolo:"' + sottotitolo_modifica + '",descrizione_breve:"' + descrizione_breve_modifica + '",descrizione:"' + descrizione_modifica + '", ID_argomento:"' + localStorage.getItem("id_modifica_argomento") + '", ID_utente:"' + localStorage.getItem("ID_utente") + '", argomento:"' + localStorage.getItem('nome_argomento_modifica') + '"}',
...
function caricaSulSitoProdotto(posizione, nome, descrizione_breve, descrizione) {
   
   
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione + '",nome:"' + nome + '", ID_categoria:"'+ localStorage.getItem('categoria_prodotto') +'", descrizione_breve:"' + descrizione_breve + '",descrizione:"' + descrizione + '",ID_utente:"' + localStorage.getItem("ID_utente") + '", user:"' + localStorage.getItem("username") + '"}',
...
function clickFiltroPerCategoriaProdotto(ID_categoria) {
    ...
    $.getJSON("http://simplyappweb.mvclienti.com/webservices/storico_prodotti_filtri_categorie.aspx?id_utente=" + localStorage.getItem("ID_utente") + "&id_categoria=" + ID_categoria + "", function (dati) {
        ...
        $.each(dati, function (i, prodotti) {
            ...
            blocco_prodotti += "<div class='blog-preview p-20'><p>" + prodotti.descrizione_breve + "</p><div class='btn_storico'><a href='#' onclick='modificaProdotto(\"" + prodotti.ID + "\");' class='waves-effect waves-light btn accent-color'><span class='ion-edit'></span></a><a href='#' onclick='cancellaNews(\"" + prodotti.ID + "\");' class='waves-effect waves-light btn accent-color'><span class='ion-close-circled'></span></a></div></div></div>";
...
function aggiornaProdotto(posizione_modifica, nome_modifica, descrizione_breve_modifica, descrizione_modifica) {
   
   
    var ID_categoria = localStorage.getItem('id_categoria_prodotto_modifica_singolo');
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione_modifica + '",nome:"' + nome_modifica + '",id_categoria:"' + ID_categoria + '",descrizione_breve:"' + descrizione_breve_modifica + '",descrizione:"' + descrizione_modifica + '", ID_utente:"' + localStorage.getItem("ID_utente") + '", ID_prodotto: "'+ localStorage.getItem('id_modifica_argomento')+'"}',
...
function caricaSulSitoRealizzazione(posizione, nome, descrizione_breve, descrizione) {

   
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione + '",nome:"' + nome + '", ID_categoria:"' + localStorage.getItem('categoria_realizzazione') + '", descrizione_breve:"' + descrizione_breve + '",descrizione:"' + descrizione + '",ID_utente:"' + localStorage.getItem("ID_utente") + '", user:"' + localStorage.getItem("username") + '"}',
...
function clickFiltroPerCategoriaRealizzazione(ID_categoria) {
    ...
    $.getJSON("http://simplyappweb.mvclienti.com/webservices/storico_realizzazioni_filtri_categorie.aspx?id_utente=" + localStorage.getItem("ID_utente") + "&id_categoria=" + ID_categoria + "", function (dati) {
        ...
        $.each(dati, function (i, realizzazioni) {
            ...
            blocco_realizzazioni += "<div class='blog-preview p-20'><p>" + realizzazioni.descrizione_breve + "</p><div class='btn_storico'><a href='#' onclick='modificaProdotto(\"" + realizzazioni.ID + "\");' class='waves-effect waves-light btn accent-color'><span class='ion-edit'></span></a><a href='#' onclick='cancellaNews(\"" + realizzazioni.ID + "\");' class='waves-effect waves-light btn accent-color'><span class='ion-close-circled'></span></a></div></div></div>";
...
function filtraArgomentoRealizzazione(stato, tipo) {
    ...
    $.getJSON("http://simplyappweb.mvclienti.com/webservices/storico_realizzazioni_filtri.aspx?id_utente=" + localStorage.getItem("ID_utente") + "&stato=" + stato + "&ricerca=" + ricerca + "&tipo_argomento=" + argomento + "&tipo_stato=" + tipo + "", function (dati) {
        ...
        $.each(dati, function (i, argomenti_filtrati) {
            ...
            blocco_realizzazioni += "<div class='blog-preview p-20'><p>" + argomenti_filtrati.descrizione_breve + "</p><div class='btn_storico'><a href='#' onclick='modificaProdotto(\"" + argomenti_filtrati.ID + "\");' class='waves-effect waves-light btn primary-color'><span class='ion-edit'></span></a><a href='#' onclick='cancellaEvento(\"" + argomenti_filtrati.ID + "\");' class='waves-effect waves-light btn primary-color'><span class='ion-close-circled'></span></a></div></div></div>";
        });
        if (lunghezza == 0) {
...
function aggiornaRealizzazione(posizione_modifica, nome_modifica, descrizione_breve_modifica, descrizione_modifica) {
    ...
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione_modifica + '",nome:"' + nome_modifica + '",id_categoria:"' + ID_categoria + '",descrizione_breve:"' + descrizione_breve_modifica + '",descrizione:"' + descrizione_modifica + '", ID_utente:"' + localStorage.getItem("ID_utente") + '", ID_realizzazione: "' + localStorage.getItem('id_modifica_argomento') + '"}',
...
function caricaSulSitoServizio(posizione, titolo, descrizione_breve, descrizione) {

   
   
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione + '", titolo:"' + titolo + '", descrizione_breve:"' + descrizione_breve + '",descrizione:"' + descrizione + '",ID_utente:"' + localStorage.getItem("ID_utente") + '", user:"' + localStorage.getItem("username") + '"}',
...
function aggiornaServizio(posizione_modifica, titolo_modifica, descrizione_breve_modifica, descrizione_modifica) {


    
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione_modifica + '",titolo:"' + titolo_modifica + '", descrizione_breve:"' + descrizione_breve_modifica + '",descrizione:"' + descrizione_modifica + '", ID_utente:"' + localStorage.getItem("ID_utente") + '", ID_servizio: "' + localStorage.getItem('id_modifica_argomento') + '"}',
...
function caricaSulSitoServiziCat(posizione, nome, descrizione_breve, descrizione) {


    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione + '",nome:"' + nome + '", ID_categoria:"' + localStorage.getItem('categoria_servizi_cat') + '", descrizione_breve:"' + descrizione_breve + '",descrizione:"' + descrizione + '",ID_utente:"' + localStorage.getItem("ID_utente") + '", user:"' + localStorage.getItem("username") + '"}',
...
function filtraArgomentoServiziCat(stato, tipo) {
    ...
    $.getJSON("http://simplyappweb.mvclienti.com/webservices/storico_servizi_cat_filtri.aspx?id_utente=" + localStorage.getItem("ID_utente") + "&stato=" + stato + "&ricerca=" + ricerca + "&tipo_argomento=" + argomento + "&tipo_stato=" + tipo + "", function (dati) {
        ...
        $.each(dati, function (i, argomenti_filtrati) {
            ...
            blocco_servizi += "<div class='blog-preview p-20'><p>" + argomenti_filtrati.descrizione_breve + "</p><div class='btn_storico'><a href='#' onclick='modificaProdotto(\"" + argomenti_filtrati.ID + "\");' class='waves-effect waves-light btn primary-color'><span class='ion-edit'></span></a><a href='#' onclick='cancellaEvento(\"" + argomenti_filtrati.ID + "\");' class='waves-effect waves-light btn primary-color'><span class='ion-close-circled'></span></a></div></div></div>";
        });
        if (lunghezza == 0) {
...
function clickFiltroPerCategoriaServiziCat(ID_categoria) {
    ...
    $.getJSON("http://simplyappweb.mvclienti.com/webservices/storico_servizi_filtri_categorie.aspx?id_utente=" + localStorage.getItem("ID_utente") + "&id_categoria=" + ID_categoria + "", function (dati) {
        ...
        $.each(dati, function (i, servizi) {
            ...
            blocco_servizi += "<div class='blog-preview p-20'><p>" + servizi.descrizione_breve + "</p><div class='btn_storico'><a href='#' onclick='modificaProdotto(\"" + servizi.ID + "\");' class='waves-effect waves-light btn accent-color'><span class='ion-edit'></span></a><a href='#' onclick='cancellaNews(\"" + servizi.ID + "\");' class='waves-effect waves-light btn accent-color'><span class='ion-close-circled'></span></a></div></div></div>";
...
function aggiornaServizioCat(posizione_modifica, nome_modifica, descrizione_breve_modifica, descrizione_modifica) {
    ...
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione_modifica + '",nome:"' + nome_modifica + '",id_categoria:"' + ID_categoria + '",descrizione_breve:"' + descrizione_breve_modifica + '",descrizione:"' + descrizione_modifica + '", ID_utente:"' + localStorage.getItem("ID_utente") + '", ID_servizio: "' + localStorage.getItem('id_modifica_argomento') + '"}',
...
function caricaSulSitoCertificazione(posizione, titolo, descrizione_breve, descrizione) {
...
function aggiornaCertificazione(posizione_modifica, titolo_modifica, descrizione_breve_modifica, descrizione_modifica) {
...
function caricaSulSitoCategoria(posizione, nome, descrizione_breve) {


    
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione + '", nome:"' + nome + '", descrizione_breve:"' + descrizione_breve + '", modifica:"' + localStorage.getItem('modifica_categoira') + '", ID_utente:"' + localStorage.getItem("ID_utente") + '", user:"' + localStorage.getItem("username") + '", argomento_categoria:"' + localStorage.getItem("argomento") + '", id_categoria:"'+localStorage.getItem('id_modifica_argomento')+'"}',
...
function  caricaSulSitoAppartamento(posizione, nome, prezzo, prezzo_scontato, prezzo_aggiuntivo_infante, n_locali, n_bagni, n_posti_letto, metri_quadri, comfort, descrizione, servizi_aggiuntivi) {
    var Lastminute;
...
function aggiornaAppartamento(posizione, nome, prezzo, prezzo_scontato, prezzo_aggiuntivo_infante, n_locali, n_bagni, n_posti_letto, metri_quadri, comfort, descrizione, servizi_aggiuntivi) {
    ...
    $.ajax({
        type: "POST",
        data: '{posizione:"' + posizione + '", nome:"' + nome + '", prezzo:"' + prezzo + '", prezzo_scontato:"' + prezzo_scontato + '", prezzo_aggiuntivo_infante:"' + prezzo_aggiuntivo_infante + '", n_locali:"' + n_locali + '", n_bagni:"' + n_bagni + '", n_posti_letto:"' + n_posti_letto + '", metri_quadri:"' + metri_quadri + '", comfort:"' + comfort + '", descrizione:"' + descrizione + '", checkPromozione:"' + Lastminute + '", servizi_aggiuntivi:"' + servizi_aggiuntivi + '", ID_utente:"' + localStorage.getItem("ID_utente") + '", ID_servizio: "' + localStorage.getItem('id_modifica_argomento') + '"}',
