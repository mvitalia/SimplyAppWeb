        ...
        submitHandler: function (form) {
            if ($('#sito').is(":checked")) {
                ...
                if (localStorage.getItem("argomento") == "")
                {
                    ...
                    caricaSulSitoArgomento(titolo, data, sottotitolo, descrizione_breve, descrizione);
                }
...
function caricaSulSitoArgomento(titolo, data, sottotitolo, descrizione_breve, descrizione) {
    var tipo_argomento = localStorage.getItem('argomento');
    $.ajax({
        type: "POST",
        data: '{titolo:"' + titolo + '",data:"' + data + '",sottotitolo:"' + sottotitolo + '",descrizione_breve:"' + descrizione_breve + '",descrizione:"' + descrizione + '",ID_utente:"' + localStorage.getItem("ID_utente") + '", user:"' + localStorage.getItem("username") + '", argomento:"'+localStorage.getItem('argomento')+'"}',
...
{
    alert(descrizione_breve_modifica);
